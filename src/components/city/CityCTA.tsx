...
import { MapPin, Phone, Mail, Send, CheckCircle, Clock, Star } from "lucide-react";
...
export const CityCTA = ({ city }: CityCTAProps) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setFormData({ name: "", email: "", phone: "", city: city.name, interventionType: "", message: "" });
    }, 3000);
  };
            ...
            {isSubmitted ? (
              <div className="flex flex-col items-center justify-center h-full py-12 text-center">
                ...
                <p className="text-muted-foreground">
                  Ti ricontatteremo entro 24 ore per fissare il sopralluogo a {city.name}.
                </p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                >
                  Richiedi Preventivo Gratuito a {city.name}
