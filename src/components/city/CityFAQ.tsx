      ...
      <div className="max-w-4xl mx-auto">
        ...
        once: true
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => <AccordionItem key={index} value={`item-${index}`} className="light-card px-6 border-none">
        ...
        once: true
          ...
          <a className="text-primary font-semibold hover:underline" href="tel:+393501780908">
            Chiamaci al +39 350 178 0908 
          </a>
        </motion.div>
      </div>
    </section>;
